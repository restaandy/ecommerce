...
CREATE TABLE `member` (
  ...
  `id_lain` varchar(30) DEFAULT NULL,
  `ket_id_lain` enum('','KTP','SIM','PASSPORT') DEFAULT NULL,
  `nama_d` varchar(30) DEFAULT NULL,
  `nama_b` varchar(30) DEFAULT NULL,
  `nama_p` varchar(30) DEFAULT NULL,
