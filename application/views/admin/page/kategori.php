	  ...
	  ?>
	   <tr>
		...
		<?php	
		 if($key['nama']!=''){
		 ?>
		  <a href="#" data-id="<?php echo $key['id_hal_subtema']; ?>" onclick="edit_hal_subtema(event);">Edit</a>
	    <?php
	    }
	    ?>
	   </tr>
...
function edit_hal_subtema(e){
  $('#hal_subtema id_hal_subtema').val($(e.target).attr('data-id'));
   $.post('<?php echo base_url(); ?>admin/load_tiny',{id:$(e.target).attr('data-id')},function(data){
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Materi Subtema</h4>
      </div>
