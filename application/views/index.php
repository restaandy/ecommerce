...
<link href="<?php echo base_url(); ?>aset/css/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- jQuery (necessary JavaScript plugins) -->
<script type='text/javascript' src="<?php echo base_url(); ?>aset/js/jquery-1.11.1.min.js"></script>
<!-- Custom Theme files -->
...
<!-- start menu -->
<link href="<?php echo base_url(); ?>aset/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="<?php echo base_url(); ?>aset/js/megamenu.js"></script>
<script>$(document).ready(function(){$(".megamenu").megamenu();});</script>
<script src="<?php echo base_url(); ?>aset/js/menu_jquery.js"></script>
<script src="<?php echo base_url(); ?>aset/js/simpleCart.min.js"> </script>
</head>
<body>
<!-- header_top -->
<div class="top_bg">
        ...
        <div class="header_right">
            ...
            <div class="cart box_1">
                <a href="checkout.html">
                    <h3> <span class="simpleCart_total">$0.00</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)<img src="<?php echo base_url(); ?>aset/images/bag.png" alt=""></h3>
                </a>    
